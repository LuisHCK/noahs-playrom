...
function moduleScene.build(moduleId)
    ...
    function scene:draw()
        ...
        love.graphics.printf(moduleData.title or self.moduleId, 0, 70, 1280, "center")
        love.graphics.printf(moduleData.subtitle or "", 0, 110, 1280, "center")
        ...
        local startX = (1280 - totalWidth) * 0.5
        ...
        love.graphics.printf("Audio key: " .. (map.intro or "n/a"), 0, 660, 1280, "center")
    end
